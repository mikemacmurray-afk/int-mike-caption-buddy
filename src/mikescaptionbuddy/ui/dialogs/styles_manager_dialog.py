...
class StylesManagerDialog(QDialog):
    ...
    # Signal emitted when styles are changed and should update dropdown
    ...
    def _setup_ui(self) -> None:
        ...
        # Left side - Project Styles list
        left_widget = QVBoxLayout()

        left_widget.addWidget(QLabel("Project Styles:"))
    ...
    def _on_delete_style(self) -> None:
        ...
        if len(self.project.styles) <= 1:
            QMessageBox.warning(self, "Cannot Delete",
                              "You must have at least one style.")
            return
    ...
    def _on_close(self) -> None:
        """Handle close button - emit signal to update dropdowns."""
        self.styles_updated.emit()
        self.accept()
